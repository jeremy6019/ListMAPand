...
public class MapMain3 {
	...
	//배열들을 가지고 뱅ㄹ을 만들 때는 분류를 위해서 
	 ...
	 for(int i=0; i<football.length; i+=1) {
		 HashMap map = football[i]; 
		 //국가이름을 직접  출력하지 않고 map에서 꺼내어 출력 
		 System.out.printf("%s:", map.get("국가"));	 
		 //출력을 제외하고 사용할 때는 
		 //원래의 자료형으로 변환해서 사용해야 합니다. 
